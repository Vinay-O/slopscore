...
`npx slopscore` flags it for you with the exact location and fix. **190 of the 286** carry this tag
...
**278 · Long function** `🟠` `🟡 PROPOSE` `⚙️ slopscore scan`
Category: code · confidence: medium. Flagged by the deterministic scanner.
...
**279 · High cyclomatic complexity** `🟠` `🟡 PROPOSE` `⚙️ slopscore scan`
Category: code · confidence: medium. Flagged by the deterministic scanner.
`DETECT:` AST metric (opt-in `--ast`, needs acorn).
...
**286 · Structural clone (function duplicated across files)** `🟠` `🟡 PROPOSE` `⚙️ slopscore scan`
Category: code · confidence: medium. Flagged by the deterministic scanner.
`DETECT:` AST cross-file analysis (opt-in `--ast`).
...
**287 · User input flows through a function into a sink (inter-procedural taint)** `🔴` `🟡 PROPOSE` `⚙️ slopscore scan`
Category: security · confidence: medium. Flagged by the deterministic scanner.
`DETECT:` AST inter-procedural analysis (opt-in `--ast`).
