...
**A zero-dependency CLI + a 174-pattern protocol for AI coding agents.**
...
## What it detects (78 of the 174)

The CLI runs the deterministic subset; the [full 174-pattern catalog](ANTI_SLOP_PROTOCOL.md) (including visual, architectural, and judgment-heavy patterns) is what you hand your agent.
